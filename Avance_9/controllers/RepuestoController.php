 ...
 * RepuestoController
 *
 * Controlador encargado de crear, editar y eliminar repuestos.
 * Recibe solicitudes HTTP desde la vista de inventario y actúa sobre
 * el modelo `MecanicoPepe` en la base de datos.
 */
session_start();
...
// Si ninguna ruta coincide, devolver un error de acción no reconocida.
