...
<body class="bg-light">
    ...
    <!-- Vista principal del panel de control para usuarios autenticados -->
            ...
            <div class="col-md-4">
                <div class="card h-100 shadow-sm border-0">
                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <p class="text-muted">
                            Consulta facturas pasadas y revisa detalles completos.
                        </p>

                        <a href="historial_view.php" class="btn btn-info w-100">
                            Ver Historial
                        </a>
