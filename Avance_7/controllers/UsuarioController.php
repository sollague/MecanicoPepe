...
// Validar token CSRF para proteger este formulario de login
$csrfToken = $_POST['_csrf_token'] ?? null;
if (!Csrf::validateToken($csrfToken, 'login_form')) {
    Logger::error('CSRF validation failed for login_form');
    Response::withError("❌ Solicitud inválida (token CSRF)", "../views/login_view.php");
}
