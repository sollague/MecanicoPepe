    ...
    <form method="POST" action="../controllers/ServicioController.php">
        ...
        <div class="card shadow border-0 mb-4">
            ...
            <div class="card-body p-4">
                ...
                <div class="form-check mb-3">
                    <input class="form-check-input" type="radio" name="tipo_mantenimiento" value="Preventivo" required>
                    <label class="form-check-label">Preventivo</label>
                </div>

                <div class="form-check">
                    <input class="form-check-input" type="radio" name="tipo_mantenimiento" value="Correctivo" required>
        ...
        <div class="card shadow border-0 mb-4">
            ...
            <div class="card-body p-4">
                ...
                <textarea name="trabajos" class="form-control" rows="5" required></textarea>
